...
import { MailProps, MailDetailsProps, MailBoxCount } from 'types/template/mail';
import { useDispatch, useSelector } from 'store';
import { getMails, filterMails, setImportant, setStarred, setRead } from 'store/slices/template/mail';
