...
import { CartCheckoutStateProps } from 'types/template/cart';
import { PaymentOptionsProps } from 'types/template/e-commerce';
import { setPaymentCard, setPaymentMethod } from 'store/slices/template/cart';
