...
import { CartStateProps } from 'types/template/cart';
import { Address } from 'types/template/e-commerce';
import { useDispatch, useSelector } from 'store';
import { getAddresses, editAddress, addAddress } from 'store/slices/template/product';
import {
    removeProduct,
    setBackStep,
    setBillingAddress,
    ...
    setStep,
    updateProduct
} from 'store/slices/template/cart';

// assets
import ShoppingCartTwoToneIcon from '@mui/icons-material/ShoppingCartTwoTone';
import ApartmentIcon from '@mui/icons-material/Apartment';
import CreditCardTwoToneIcon from '@mui/icons-material/CreditCardTwoTone';
import useConfig from 'services/hooks/useConfig';
