...
import { addStory } from 'store/slices/template/kanban';

// types
import { DefaultRootStateProps } from 'types';
import { KanbanColumn, KanbanProfile } from 'types/template/kanban';
                                        ...
                                        <Grid item xs={12} sm={8}>
                                            <Grid container justifyContent="flex-start">
                                                <Autocomplete
                                                    id="assign"
                                                    value={
                                                        profiles.find((profile: KanbanProfile) => profile.id === formik.values.assign) ||
                                                        null
                                                    }
