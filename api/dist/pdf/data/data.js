                    ...
                    projects: [
                        {
                            ...
                            description: "Manage and create reports for businesses, focus on processing data in excel and pdf files.",
                            contribute: [
                        ...
                        },
                        {
                            ...
                            description: "Using Amazon Cognito to manage users, socket for action with real-time bettween users. Follow the requirement that generates 3D code and connect to the 3D printer to print the 3D image",
                            contribute: [
                        ...
                        },
                        {
                            name: "Keyreply",
                            technology: ["VueJs,NodeJs"],
                            description: "Create chat-bot for client to talk with user about the quick information. Management the process of users from client 's website. Training bot for better answer to user",
                            contribute: [
